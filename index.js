...
/*Görev 1: macSkoru()
  ...
  skor1 de skor değişkenini local scope dan alıyor ama skor2 de skor değişkenini global scope dan almaktadır...
...
function skorTabelasi(periyotSkoru, takimSkoru, ceyrekSayisi) {
  ...
  for (let i = 0; i < ceyrekSayisi; i++) {
    ...
    let metin = `${i + 1}. Periyot: Ev Sahibi ${skor.EvSahibi} - Konuk Takım ${
      skor.KonukTakim
    }`;
